...
namespace AlHamzaEnterprises.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InvoiceID,Discount,SalesTax,WithHoldingTax,PaidAmount,OrderID")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InvoiceID,Discount,SalesTax,WithHoldingTax,PaidAmount,OrderID")] Invoice invoice)
        {
            if (ModelState.IsValid)
            {
