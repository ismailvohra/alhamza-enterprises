...
namespace AlHamzaEnterprises.Controllers
{
    public class DealersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DealerID,DealerName,MobileNo,Landline,CompanyName,SalesTax_,NTN_")] Dealer dealer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DealerID,DealerName,MobileNo,Landline,CompanyName,SalesTax_,NTN_")] Dealer dealer)
        {
            if (ModelState.IsValid)
            {
